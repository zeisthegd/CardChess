...
public partial class @PlayerInput : IInputActionCollection2, IDisposable
{
    ...
    private IPlayCardActions m_PlayCardActionsCallbackInterface;
    ...
    public struct PlayCardActions
    {
        ...
        {
            if (m_Wrapper.m_PlayCardActionsCallbackInterface != null)
            {
                @Choose.started -= m_Wrapper.m_PlayCardActionsCallbackInterface.OnChoose;
                @Choose.performed -= m_Wrapper.m_PlayCardActionsCallbackInterface.OnChoose;
                @Choose.canceled -= m_Wrapper.m_PlayCardActionsCallbackInterface.OnChoose;
                @Cancel.started -= m_Wrapper.m_PlayCardActionsCallbackInterface.OnCancel;
                @Cancel.performed -= m_Wrapper.m_PlayCardActionsCallbackInterface.OnCancel;
                @Cancel.canceled -= m_Wrapper.m_PlayCardActionsCallbackInterface.OnCancel;
            }
            m_Wrapper.m_PlayCardActionsCallbackInterface = instance;
            if (instance != null)
            {
